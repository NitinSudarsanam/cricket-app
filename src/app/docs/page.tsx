  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <section className="bg-white rounded-md border border-slate-200 p-6 mb-6">
          <h2 className="text-xl font-semibold text-slate-900 mb-3">Quick Start</h2>
          <ol className="list-decimal list-inside space-y-2 text-slate-700">
            <li>Open the <Link href="/admin" className="text-emerald-600 hover:underline">Admin Panel</Link>.</li>
            ...
            <li>Participants join via <Link href="/draft" className="text-emerald-600 hover:underline">Join Draft</Link>, select their name, and make picks when it's their turn.</li>
          </ol>
        </section>
        ...
        <section className="bg-white rounded-md border border-slate-200 p-6">
