...
export function IconTrophy({ className }: { className?: string }) {
  return (
    <svg className={className ?? iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 3v4m4-4v4M4 6h4m-4 4h4m8-8v4m4-4v4M16 6h4m-4 4h4M5 21v-4M3 17h4m-4 4h4m8-4v4M16 17h4m-4 4h4M12 3v4m0 14v-4m0 0h4m-4 0H8" />
    </svg>
  );
}

export function IconCricket({ className }: { className?: string }) {
  return (
    <svg className={className ?? iconClass} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
